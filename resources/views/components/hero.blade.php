<section {{ $attributes->merge(['class' => 'flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row
    ...
    <div class="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
        ...
        <p class="mt-6 mb-8 text-lg sm:mb-12">Lorem ipsum dolor sit amet consectetur.
            <br class="hidden md:inline lg:hidden">Lorem ipsum dolor sit amet consectetur.
        </p>
        <div
            ...
            <a rel="noopener noreferrer" href="#"
                class="px-8 py-3 text-lg font-semibold rounded dark:bg-blue-400 dark:text-gray-900">get started</a>
            <a rel="noopener noreferrer" href="#"
