<div
    class="relative top-1/2 left-1/2 -translate-x-1/2 translate-y-1/2 h-full w-[50%] flex flex-col px-4 pt-5 pb-4 text-left align-bottom transition-all bg-white rounded-lg shadow-xl dark:bg-gray-800 sm:my-8 sm:p-6 sm:align-middle">
    <h3 class="text-lg font-medium leading-6 text-gray-800 capitalize dark:text-white" id="modal-title">
        Modify your request
    </h3>
    <p class="mt-2 text-sm text-red-700 dark:text-red-700">
